...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'cmsplugin_forms_builder', ['Forms'])


    def backwards(self, orm):
        # Deleting model 'Forms'
        db.delete_table(u'cmsplugin_forms_builder_forms')
    ...
    models = {
        ...
        u'cmsplugin_forms_builder.forms': {
            'Meta': {'object_name': 'Forms', '_ormbases': ['cms.CMSPlugin']},
    ...
    complete_apps = ['cmsplugin_forms_builder']